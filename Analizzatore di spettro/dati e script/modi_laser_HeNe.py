...
print('media_nu_basso            =', media_nu_basso)
print('media_nu_alto             =', media_nu_alto)
print('media_sinistra_destra     =', media_sinistra_destra)
print('media_alto_basso          =', media_alto_basso)
...
tutto = numpy.concatenate((nu_sinistra, nu_destra))
