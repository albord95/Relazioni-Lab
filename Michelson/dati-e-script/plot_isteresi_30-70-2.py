...
files_frange = ['borcapMMfrangeisteresi06.txt', 'borcapMMfrangeisteresi07.txt']
files_volt = ['borcapMMvoltisteresidiscesa06.txt', 'borcapMMvoltisteresisalita07.txt']
cuts = [[10, 170], [10, 165]]
d_start = 30.068
verso = -1 # 1 = salita, -1 = discesa

figure('isteresi_30-70').set_tight_layout(True)
clf()
