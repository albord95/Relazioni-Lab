...
\begin{center}
	...
	\begin{minipage}[c]{.40\textwidth}
		In un interferometro di Michelson come quello in figura la condizione per avere interferenza costruttiva è 
		\begin{equation}
		2(L_1 -L_2)n = m \lambda\ 
		\label{eq:interferenza}
		\end{equation}
		dove $n$ è l'indice di rifrazione dell'aria e $m$ è il numero di frange. Nel nostro apparato variamo $L_2$ e contiamo la corrispondente variazione di $m$.
	\end{minipage}
\end{center}
...
Al termine dell'acquisizione il VI fornisce il numero $m$ di picchi e il display del vita micrometrica fornisce la distanza percorsa dallo specchio M2 che usiamo per calcolare la lunghezza d'onda tramite l'equazione \ref{eq:interferenza}.
...
\begin{multicols}{2}
Come si può vedere in tabella i valori misurati sono compatibili con gli intervalli ottenuti dal modello teorico considerato.
