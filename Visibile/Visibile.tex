...
Abbiamo quindi cercato di verificare in che intervallo quest'approssimazione è giustificata eseguendo un fit con la funzione $y = ax^b$ aumentando di 1 mW l'intervallo di dati considerato partendo da $P_{max}$=5 mW fino a $P_{max}$=30 mW.
...
Come mostrato in Figura \ref{fig:potenza_allab} il valore di $b$ ottenuto dal fit è in accordo con quello atteso finché $P_{max} < 25 mW$. 

\'E possibile comprendere in modo migliore l'intervallo in cui è valido il regime di basso pompaggio se si osservano i grafici in Figura \ref{fig:andamento_cut} e in Figura \ref{fig:fluttuazioni_cut}.
...
\begin{minipage}[c]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{fluttuazioni_cut.pdf}
\caption{}
\label{fig:fluttuazioni_cut}
\end{minipage}
\end{figure}

\begin{multicols}{2}

In Figura \ref{fig:andamento_cut} è mostrato l'andamento dei risultati ottenuti dal fit per b in funzione della potenza massima fino a cui è stato eseguito il rispettivo fit.
