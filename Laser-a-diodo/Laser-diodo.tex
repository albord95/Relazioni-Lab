...
Questi valori sono stati scelti a posteriori una volta visualizzato l'andamento delle misure e sono stati quindi considerati valori di P maggiori di 300 $\mu$W così da avere un andamento lineare ben definito.
...
I valori di $I_{th}$ sono stati ricavati trovando l?intercetta con l?asse delle ascisse una volta ottenuti tramite il fit lineare i valori di coefficiente angolare e intercetta con l'asse delle ordinate. 

\section{Divergenza del fascio}

In questa seconda sezione calcoliamo un'altra caratteristica importante di un diodo laser; i valori dell'allargamento angolare lungo i due assi della giunzione così da poterli confrontare con quelli riportati sul datasheet. Per farlo abbiamo misurato l'andamento della potenza emessa dal diodo laser in funzione dell'angolo di emissione.
